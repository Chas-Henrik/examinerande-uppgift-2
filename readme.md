...
_Authentication, authorization, rate limiting samt delar av validering & felhantering_ utförs i middleware för att kunna återanvända så mycket kod som möjligt och för att göra applikationen mindre felbenägen. Detta är även något som ChatGPT kräver för att godkänna applikationen som 'production ready'.  
